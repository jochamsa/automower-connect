export declare enum MowerState {
    UNKNOWN = "UNKNOWN",
...
export declare enum AutoMowerCommand {
    Start = "Start",
    Pause = "Pause",
...
export declare enum MowerActivity {
    UNKNOWN = "UNKNOWN",
    NOT_APPLICABLE = "NOT_APPLICABLE",
    MOWING = "MOWING",
...
export declare enum HusqvarnaMowerErrorCode {
    UnexpectedError = 0,
...
export declare enum RestrictedReason {
    NONE = "NONE",
...
export declare enum HeadlightMode {
    ALWAYS_ON = "ALWAYS_ON",
